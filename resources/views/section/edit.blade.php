...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Section') }}
...
<form action="{{ url('section/update/' . $section->id) }}" method="post" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" id="description" name="description" rows="3" placeholder="{{ __('Enter description') }}">{{ old('description', $section->description) }}</textarea>
  ...
  <div class="form-group">
      ...
      <div class="custom-control custom-checkbox">
          <input
            ...
            name="users[]"
            value="{{ $user->id }}"
            {{ in_array($user->id, $section_users) ? 'checked' : '' }}
            >
